...
class fpi_mpi_xi_inverse_NNLO(Model):
    ...
    def __init__(self, ensemble_datas, options):
        ...
        self.update_paramdict("F_0", 121.8, 5.1, limits=(0, None))
        self.update_paramdict("B", 2850.37, 20.0, limits=(0, None))

        self.update_paramdict("Lambda3", 700.59, 50.0, limits=(0, None))
        self.update_paramdict("Lambda4",  1000.35, 140.55, limits=(0, None))
        self.update_paramdict("Lambda12", 20.0, 0.1, limits=(0, None), fix=True)
...
class fpi_mpi_xi_NNLO(Model):
    ...
    def __init__(self, ensemble_datas, options):
        ...
        self.update_paramdict("F_0", 130.8, 0.1, limits=(0, None))
        self.update_paramdict("B", 2736.37, 1.0, limits=(2500, None))

        self.update_paramdict("c3", 1453.0, 1.0, limits=(-1000, 4000))
...
class fpi_xi_inverse_NLO(Model):
    ...
    def __init__(self, ensemble_datas, options):
        ...
        self.update_paramdict("F_0", 130.8, 0.1, limits=(0, None))
        self.update_paramdict("Lambda4", 1100.0, 1.0)
    ...
    def m(self, xi, F_0, Lambda4, gamma_2=0, gamma_s2=0):
        ...
        Fpi = delta_F * (F_0 / (1 - xi*np.log(arg4)))

        return Fpi


    def sqr_diff(self, F_0, Lambda4, gamma_2, gamma_s2):

        xi = self.bstrapdata("xi")
        F = self.m(xi, F_0, Lambda4, gamma_2, gamma_s2)
        sqr_diff2 = (self.bstrapdata("fpi") - F)**2
        return np.sum(sqr_diff2 / self.var2)
...
class mpi_xi_NLO(Model):
    ...
    def __init__(self, ensemble_datas, options):
        ...
        self.update_paramdict("B", 2835.0, 0.1, limits=(0, None))
...
class mpi_xi_inverse_NLO(Model):
    ...
    def __init__(self, ensemble_datas, options):
        ...
        self.update_paramdict("B", 2835.0, 0.1, limits=(0, None))
        self.update_paramdict("Lambda3", 1453.0, 1.0)
