...
def interpolated_fsqrtm(ed, options, heavy="m0"):
    df = ed.select_data("heavy-s", operator="fsqrtm_continuum", smearing="0_0", heavy="m0").values
...
def interpolated_fsqrtm_hqet(ed, options, heavy="m0"):
    df = ed.select_data("heavy-s", operator="fsqrtm_hqet_continuum", smearing="0_0", heavy="m0").values
...
def interpolated_fsqrtm_linearhqet(ed, options, heavy="m0"):
    df = ed.select_data("heavy-s", operator="fsqrtm_linearhqet_continuum", smearing="0_0", heavy="m0").values
